...
<grid drag="50 50" drop="50 10" align="topright">
![](assets/nucleus.svg)
</grid>

<grid drop="0 50" drag="100 50" align="bottom">
![](assets/feynman.svg)
</grid>
...
<grid drag="100 100" drop="top" flow="col" align="center">
# Tensor Nets
...
<grid drag="40 40" drop="center" align="center" class="note">
...
::: block <!-- .element style="text-align:center!important;margin-left:10%;margin-right:10%;border:1px solid white;margin-top:1%;margin-bottom:1%;" align="center" class="note"-->
...
<split even>
::: block <!-- .element class="note" style="margin-right:0%;font-size:0.9em;" align="bottom" -->
...
::: block <!-- .element class="note" style="margin-left:1%;font-size:0.9em;" -->
...
<grid drag="30 20" drop="33 20" align="center" class="note" style="font-size:1.5em;margin-bottom:20%;">

$$\begin{align} \dot{x} &= +\partial_{v} H \\ \dot{v} &= - \partial_{x} H \end{align}$$
</grid>
...
<section data-background-iframe="https://chi-feng.github.io/mcmc-demo/app.html" data-background-interactive>
...
# Critical Slowing Down <!-- .element style="color: #3B4CC0;" -->
...
::: block <!-- .element class="note" bg="#66BB6A" style="border:1px solid #66BB6A" -->
  ...
  1. **Gauge Field Generation**: Use Markov Chain Monte Carlo (MCMC) methods
...
::: block <!-- .element class="note" style="margin-left:25%;margin-right:25%;" -->
...
`output`: $\textcolor{#00CF53}{S_{x}, T_{x}, Q_{x}}$ <!-- .element class="note" -->

:::


<grid drag="100 10" drop="bottom" align="bottom">
**Note**: $\textcolor{#ff5252}{\lambda_{S}}$, $\textcolor{#ff5252}{\lambda_{Q}}$ are trainable parameters <!-- .element class="footer" align="bottom" -->
</grid>
...
- $\textcolor{#FA5252}{\delta Q_{\mathbb{R}}}$ is the <span id="red">tunneling rate</span> <!-- .element style="text-align:left" -->
...
::: block <!-- .element style="font-size:0.75em!important;text-align:left;" -->
...
![](./assets/hmcNlf16_sweep2.svg) <!-- .element align="center" style="align:center!important;text-align:center!important;width:90%;" -->

HMC Sweep with $N_{\mathrm{LF}}=16$ on $16\times16$ lattice at $\beta = 4$
<!-- .element style="font-size:0.8em;color:#757575;vertical-align:bottom;text-align:center;" -->
...
Comparison of the tunneling rate between trained model (left) and HMC (right). <!-- .element class="footer" -->

---

#### Integrated Autocorrelation time: $\textcolor{#FF2052}{\tau_{\mathrm{int}}}$

<grid drop="5 10" drag="30 45" align="right" style="text-align:right!important;">
...
<grid drop="35 10" drag="65 65" align="topleft" style="">
...
<grid drag="100 90" drop="0 10" flow="row" align="stretch">
...
# Interpretation
![](./assets/plaqsf_ridgeplot.svg) <!-- .element width="45%" align="topright" -->
...
- Plot showing how <b>average plaquette</b>, $\left\langle x_{P}\right\rangle$ varies over a single trajectory for models trained at different $\beta$, with varying trajectory lengths $N_{\mathrm{LF}}$
...
# <a href="https://www.github.com/saforem2/l2hmc-qcd"><i class="fab fa-github" /></a> `l2hmc-qcd` <div align="center">  
...
::: block <!-- .element class="note" bg="#66bb6a" style="margin-left:20%;margin-right:20%;" -->
